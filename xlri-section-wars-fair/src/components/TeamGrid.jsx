 ...
 * TeamCard
 * --------
 * Displays either an image or the placeholder if no image is provided.
 */
function TeamCard({ letter, index, image }) {
  const [ref, isVisible] = useScrollReveal();

  return (
    <article
      ref={ref}
      className={`team-card reveal reveal--zoom ${
  ...
  return (
    <section id={id} className="team-grid">
      <div className="container">
        <header
          ref={headerRef}
          className={`team-grid__header reveal ${
